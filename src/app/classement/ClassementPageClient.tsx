...
import { Trophy, TrendingUp, Target, Award, ArrowUpDown, ArrowUp, ArrowDown } from "lucide-react";
...
type SortField = "totalPoints" | "totalWins" | "totalLosses" | "totalBullseyes" | "totalTriples" | "playerName";
type SortDirection = "asc" | "desc";

export default function ClassementPageClient({ seasons, currentSeason, rankings }: ClassementPageProps) {
  ...
  const SortableHeader = ({ field, children }: { field: SortField; children: React.ReactNode }) => (
    <TableHead className="font-bold cursor-pointer hover:bg-slate-100" onClick={() => handleSort(field)}>
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-slate-50 hover:bg-slate-50">
                  ...
                  <SortableHeader field="totalPoints">
                    <div className="flex items-center justify-center gap-1">
                      <TrendingUp className="w-4 h-4" />
                      Points
                    </div>
                  </SortableHeader>
                  <SortableHeader field="totalWins">
                    <div className="flex items-center justify-center gap-1">
                      Victoires
                    </div>
                  </SortableHeader>
                  <SortableHeader field="totalLosses">
                    <div className="flex items-center justify-center gap-1">
                      Défaites
                    </div>
                  </SortableHeader>
                  <SortableHeader field="totalBullseyes">
                    <div className="flex items-center justify-center gap-1">
                      <Target className="w-4 h-4" />
                      Bulls
                    </div>
                  </SortableHeader>
                  <SortableHeader field="totalTriples">
                    <div className="flex items-center justify-center gap-1">
